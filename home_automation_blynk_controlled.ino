...
#define BLYNK_TEMPLATE_ID "TMPL34unhWYSz"
#define BLYNK_TEMPLATE_NAME "Home Automation"
#define BLYNK_AUTH_TOKEN "5Kktgr61Y1Bej0ESs3JJ1RCeqk7ko1CV"
...
void handle_tank(void)
{
  if((tank_volume<2000) && (inlet_sw==0)){
    ...
    lcd.setCursor(7,1);
    lcd.print("IN_FL_ON ");
    // if tank is full turn off inlet
    /*if volume is 1000 ltr , inlet is on*/
  }
...
void setup(void)
{
    ...
    init_serial_tank();
    // update temparature to blynk app for every second
...
{
    brightness_control();
    //temperature_check_cooler_heater
    ...
    //To connect device continuosly to the cloud
    Blynk.run();
    timer.run();
    handle_temp();
    handle_tank();
